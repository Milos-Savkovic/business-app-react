...
class ReportDetails extends Component {
  ...
  componentWillMount() {
    fireDB.ref(`/users/${this.props.id}`).on(
      'value',
      snapshot => {
        this.setState({
          user: snapshot.val()
  ...
  sumOf = (arrayOf, prop) => {
    if (arrayOf && prop === 'KM') {
      const arrayOfObjectsProp = arrayOf.map(
        object =>
          object[prop] !== ''
            ? +parseFloat(object[prop].replace(/,/g, '.')).toFixed(2)
            : 0
      );
      const sumOfObjectsProp = arrayOfObjectsProp.reduce(
        (total, value) => total + value
      );
      return sumOfObjectsProp;
    } else if (arrayOf) {
      const arrayOfObjectsProp = arrayOf.map(
        object => (object[prop] !== '' ? parseFloat(object[prop]) : 0)
      );
      const sumOfObjectsProp = arrayOfObjectsProp.reduce(
        (total, value) => total + value
      );
      ...
      if (this.state.user) {
        const direction = array => {
          const directions =
            array.length > 1
              ? array
                  .filter(city => city.to !== 'Banja Luka')
                  .map(city => `${city.to}`)
                  .join(' - ')
        ...
        const days = report.days
          ? report.days
          : this.substructDays(report.date1, report.date2) +
            (startHour < 17 ? 1 : 0);
        ...
        const cities = report.towns.map(town => ({
          ...
          busTicket: town.busTicket
        }));
        const totalDistance = this.sumOf(cities, 'distance');
        const totalCosts = {
          daily: this.dayPay(report.dailyEarnings) * days,
          transition:
            report.typeOfTransport !== 'službeno'
              ? this.sumOf(cities, 'busTicket') ||
                this.fuelPrice(
                  report.towns,
                  'distance',
                  report.personalVehicleFuel,
                  report.fuelPrice
                )
              : 0,
        ...
        const extraCosts = report.moreCosts
          ? report.moreCosts.map(obj => {
              const newObj = Object.assign({}, obj);
              newObj.name =
                newObj.number > 1
                  ? (newObj.name = `${newObj.name}(${newObj.number})`)
                  : newObj.name;
              return newObj;
            })
          : [];
        return (
          <div>
            <div className="report-container" id="report">
              <div className="right-border-report" id="report-page-1">
                ...
                <div className="report-row-no-line">
                  ...
                  >
                    ...
                    <div className="floor-border medium-width-border">
                      {report.protocol}
                    </div>
                  </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div className="floor-border">{`${this.props.firstName} ${
                      this.props.lastName
                    }`}</div>
                  </div>
                </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span className="report-text">
                      sa dnevnicom (domaćom ili stranom)
                    </span>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div className="floor-border floor-border--end">
                      {dailyEarnings}&nbsp;KM&nbsp;
                    </div>
                  </div>
                </div>
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span className="report-text">
                      otputovaće po službenom poslu u mjesto-a
                    </span>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div className="floor-border" style={{ width: '8rem' }}>
                      {days}
                    </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span className="report-text">
                      Troškovi putovanje padaju na teret
                    </span>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span className="report-text">
                      Na službenom putu će koristiti prevozno sredstvo
                    </span>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span className="report-text">
                      Na službenom putu će se zadržati najdalje do:{' '}
                    </span>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    >
                      a u roku od 48 časova po povratku sa službenog puta i
                      dolaska na posao, podneće pismeni izveštaj o obavljenom
                      poslu. Račun o učinjenim putnim troškovima podneti u roku
                      od sedam dana.
                    </span>
                  </div>
                </div>
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div className="floor-border floor-border--start">
                      {report.costs}
                    </div>
                  </div>
                </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span
                      ...
                      style={{ paddingRight: '1rem' }}
                    >
                      Odobravam isplatu akontacije u iznosu od KM
                    </span>
                ...
                <div className="paraf-bottom">
                  <div className="report-row-no-line">
                    <div className="report-field report-field--end">
                      <span className="report-text report-text--right-padding">
                        Nalogodavac,
                      </span>
                    </div>
                  </div>
              ...
              <div className="no-right-border-report" id="report-page-2">
                <h4 className="text-center">
                  Na osnovu prednjeg naloga izvršio sam službeno putovanje i
                  podnosim sledeći
                </h4>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    <span
                      className="report-text"
                      style={{ whiteSpace: 'inherit', fontSize: '1.3rem' }}
                    >
                      Potvrđujem da je putovanje izvršeno prema ovom nalogu i
                      odobravam uplatu
                    </span>
                  </div>
                </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div className="floor-border floor-border--center">
                      kompanije
                    </div>
                  </div>
                </div>
                ...
                <div className="report-row-no-line">
                  <div className="report-field">
                    ...
                    <div
                      className="floor-border floor-border--center"
                      style={{ width: '12rem' }}
                    >
                      Banjoj Luci
                    </div>
                    ...
                    <div
                      className="floor-border floor-border--center"
                      style={{ width: '12rem' }}
                    >{`${moment().format('DD.MM.YYYY.')} godine`}</div>
                  </div>
                </div>
                <br />
                <br />
                ...
                <div className="paraf-bottom">
                  <div className="report-row-no-line">
                    <div className="report-field report-field--end">
                      <span
                        className="report-text report-text--right-padding"
                    ...
                    <div className="report-field report-field--end">
                      <div style={{ width: '22rem' }}>
                        <small style={{ fontSize: '13px' }}>
                          Potpis ovlašćenog lica nalogodavca koje odobrava
                          isplatu
                        </small>
                      </div>
                    </div>
            ...
            <button className="print-report-button" onClick={this.printReport}>
              Print report
              <PrintIcon
                // color="#3cb8ff"
                // hoverColor="#fff"
